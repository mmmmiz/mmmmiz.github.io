export default function About() {
    return (
        <section id="about" className="relative z-0 min-h-screen flex justify-center items-center bg-white/3">
            <div className="rounded-2xl py-16 px-20 text-center max-sm:px-8 max-sm:py-10 max-sm:mx-4">
                ...
                <p className="text-center text-sm/8">
                    ...
                    もともと臨床検査技師として10年以上、
                    <br />
                    超音波検査を専門に様々な医療現場で診断の最前線に立ってきました。
                    <br />
                    その後、医療機器メーカーに勤務し、
                    <br />
                    ...
                    臨床知識とプログラミングを活かしながら、
                    <br />
                    価値ある製品を作り続けることを目指しています。
                    <br />
                    <br />
                    制作ではフロントエンドからバックエンドまで幅広く対応し、
                    <br />
                    ユーザーにとって使いやすく、美しいプロダクトを作ることを心がけています。
                    <br />
                    <br />
